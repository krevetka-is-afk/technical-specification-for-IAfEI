...
#figure(
    ...
    table(
        ...
        [Изоляция контекста и защита границ доверия], plus, minus, minus,
...
#figure(
    ...
    text(size: 12pt, table(
        ...
        [Согласование ТЗ], [Утверждение состава функций и технических метрик], [10.12.25 --\ 16.12.25],
        ...
        [Подготовка данных], [Сбор и очистка документов PDF, HTML, HTM, TXT и DOCX, формирование метаданных], [01.01.26 --\ 10.03.26],
        [Векторное хранилище], [Построение и валидация индекса Chroma на корпусе документов], [01.01.26 --\ 24.02.26],
        [Генеративная модель и правила обращения], [Настройка Ollama, системных инструкций и резервного ответа из найденных фрагментов], [01.01.26 --\ 24.02.26],
        [Интерфейсы], [Интеграция Telegram и веб-интерфейса с серверным API, авторизация и журналирование], [25.02.26 --\ 25.03.26],
        ...
        [Документация и сдача], [Актуализация инструкций, развертывание на тестовом сервере, отчетность], [16.04.26 --\ 25.04.26],
    ))
)
...
- Разработка и настройка серверного ядра системы: векторная база данных, метод RAG, генеративная модель и программный API — С. Е. Растворов.
