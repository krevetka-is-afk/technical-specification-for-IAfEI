#let data = (
  ...
  github_url: "https://github.com/krevetka-is-afk/Intelligent-Assistant-for-Educational-Institutions.git",
  ...
  functional_requirements: (
    composition: (
      ...
      [Генерация ответов LLM (Ollama qwen2.5:3b или внешние API) с промптами, адаптированными под образовательный контекст.],
  ...
  exploitation: (
    ...
    staff: (
      [1 разработчик/ML-инженер для поддержки RAG/LLM и релизов — С. Е. Растворов.],
      [1 контент-менеджер/аналитик для подготовки корпуса документов — А. К. Соколова.],
  ...
  software: (
    ...
    [Ollama (qwen2.5:3b) или внешние LLM API (при наличии доступа).],
  ...
  tests: (
    ...
    acceptance: (
      [Не менее 85% вопросов из контрольного набора на основе индексированных документов получают корректную выдачу фрагментов.],
      [Не менее 70% вопросов получают корректный ответ.],
      [Среднее время ответа ≤ 420 секунд при доступной локальной модели; при деградации отображается предупреждение и fallback.],
