...
#figure(
    table(
        ...
        [Проработка предметной области и требований], [Определение источников данных, API и метрик качества], [10.02.25 --\ 17.02.25],
        [Согласование ТЗ], [Утверждение состава функционала и критериев для бэкенда], [18.02.25 --\ 24.02.25],
        ...
        [RAG API и LLM], [FastAPI /ask, авторизация, подбор промптов, fallback-сценарии], [11.03.25 --\ 24.03.25],
        [Интеграции и логирование], [Интерфейсы Telegram/web, мониторинг, алерты], [25.03.25 --\ 05.04.25],
        ...
        [Документация и сдача], [Инструкции, деплой на тестовый сервер, отчетность], [26.04.25 --\ 30.04.25],
    )
)
