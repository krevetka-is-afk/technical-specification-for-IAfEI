...
#figure(
    table(
        ...
        [Согласование ТЗ], [Утверждение состава функционала и метрик], [10.12.25 --\ 16.12.25],
        ...
        [Подготовка данных], [Сбор и очистка PDF/HTML, OCR, формирование метаданных], [01.01.26 --\ 10.03.26],
        [Векторное хранилище], [Построение и валидация индекса Chroma на корпусе документов], [01.01.26 --\ 24.02.26],
        [LLM и промпты], [Настройка Ollama/внешних API, шаблоны промптов и fallback-сценарии], [01.01.26 --\ 24.02.26],
        [Интерфейсы], [Интеграция Telegram/web с RAG API, авторизация и логирование], [25.02.26 --\ 25.03.26],
        ...
        [Фокус-группа], [Пилотное тестирование, сбор и анализ обратной связи], [01.04.26 --\ 16.04.26],
        [Документация и сдача], [Актуализация инструкций, деплой на тестовый сервер, отчетность], [16.04.26 --\ 25.04.26],
    )
)
...
- Создание интерфейсов (UI) и организация тестирования с реальными пользователями — Л. А. Субботин.
